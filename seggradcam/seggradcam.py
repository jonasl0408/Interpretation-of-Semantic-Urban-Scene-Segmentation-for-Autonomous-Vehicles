...
class SegGradCAM:
    ...
    def __init__(self, input_model, image, cls, prop_to_layer='activation_9', prop_from_layer='last',
    ...
    def featureMapsGradients(self):
        ...
        #print('self.grads_val',self.grads_val)
        #print('self.A',self.A)
    ...
    def activationMap(self):
        ...
        self.cam = cam
        #print('self.cam.shape', self.cam.shape)
